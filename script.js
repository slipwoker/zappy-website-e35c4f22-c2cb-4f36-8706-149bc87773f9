      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        requiredFields.forEach(function(field) {
          var errorEl = field.closest('.form-group') ? 
            field.closest('.form-group').querySelector('.form-error') : null;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e35c4f22-c2cb-4f36-8706-149bc87773f9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e35c4f22-c2cb-4f36-8706-149bc87773f9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e35c4f22-c2cb-4f36-8706-149bc87773f9';
